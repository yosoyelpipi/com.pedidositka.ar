...
$client = new nusoap_client($ws,true);
	...
	if ($sError) {
		...
		if($error){
				...
				$empresas = $client->call('ItsGetData', array('UserSession' => $session, 'ItsClassName' => 'ERP_EMPRESAS', 'RecordCount' => '100', 'SQLFilter'=>"FEC_ULT_ACT > '".$fua."' and _ERP_HAB_MOBILE = 1 " , 'SQLSort'=> '') );
